...
export const LandingPage: React.FC<LandingPageProps> = ({ onLaunchApp }) => {
  ...
  // Interactive Guardrails Simulator state
  ...
  // Auto cycle scenarios every 5 seconds unless manually interacted
  useEffect(() => {
  ...
  // Dynamically compute simulated precision based on slider state
  ...
  return (
    <div className="min-h-screen bg-[#0b0e17] text-slate-100 font-sans selection:bg-indigo-600 selection:text-white flex flex-col relative overflow-hidden">
      ...
      <div className="bg-indigo-600/10 border-b border-indigo-500/20 py-2 px-4 text-center text-xs font-mono text-indigo-300 flex items-center justify-center gap-2 z-50">
        ...
        <button 
          ...
          className="ml-2 underline font-semibold text-white hover:text-indigo-200"
        >
          Launch Terminal →
        </button>
      </div>
      ...
      {/* Navigation Header */}
      <header className="border-b border-slate-800/80 bg-[#0c0e17]/90 backdrop-blur-xl sticky top-0 z-40 px-6 lg:px-12 py-3.5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="ml-2 text-[10px] font-mono font-semibold px-2 py-0.5 rounded-full bg-indigo-500/10 text-indigo-300 border border-indigo-500/20">
                Track 04
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={() => onLaunchApp('HONEST')}
              className="hidden sm:flex items-center gap-1.5 text-xs text-slate-400 hover:text-amber-300 transition-all font-mono px-3 py-1.5 rounded-lg border border-slate-800 bg-slate-900/60"
            >
            ...
            <button
              onClick={() => onLaunchApp('DASHBOARD')}
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-sm transition-all group"
            >
      ...
      <section className="relative pt-16 pb-12 px-6 lg:px-12 max-w-7xl mx-auto text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-14">
          <button
            onClick={() => onLaunchApp('DASHBOARD')}
            className="w-full sm:w-auto px-7 py-3.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold shadow-md transition-all flex items-center justify-center gap-2 group cursor-pointer"
          >
          ...
          <button
            onClick={() => onLaunchApp('REPLAY')}
            className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-slate-900/90 hover:bg-slate-800 text-slate-200 border border-slate-800 text-sm font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
        ...
        {/* Dynamic Animated Telemetry Preview Card */}
        <div className="max-w-5xl mx-auto rounded-2xl surface-card border border-slate-800/80 p-2 shadow-2xl text-left relative group">
          ...
          <div className="relative bg-[#0c0e17] rounded-xl p-4 sm:p-6 border border-slate-800/80 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
              ...
              <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 space-y-1.5 relative overflow-hidden">
                <div className="flex items-center justify-between text-[10px] font-mono text-indigo-400 font-bold uppercase">
                  <span className="flex items-center gap-1">
                    <Cpu className="w-3 h-3" /> Agent 01: Delta Diagnostic
                  </span>
              ...
              <div className="p-3.5 rounded-xl bg-slate-900/80 border border-slate-800 space-y-1.5 relative overflow-hidden">
                <div className="flex items-center justify-between text-[10px] font-mono text-emerald-400 font-bold uppercase">
                  <span className="flex items-center gap-1">
                    <FileCheck className="w-3 h-3" /> Agent 03: Fee & Tax Matcher
                  </span>
                  <CheckCircle2 className="w-3 h-3 text-emerald-400" />
                </div>
            ...
            {/* Dual-Key Auditor Decision Banner */}
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <div className="text-[11px] text-slate-500 font-sans">
                    Primary hypothesis verified against counterfactual challenger agent.
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white font-sans leading-tight">
              Test Deterministic Policy Guardrails in Real Time.
            </h2>
            <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
              In financial operations, LLM confidence alone is insufficient. Adjust the policy guardrail parameters below to observe how SettleWise enforces mathematical safety boundaries.
            </p>
          </div>
          ...
          <div className="lg:col-span-7 surface-card p-6 rounded-2xl border border-slate-800/80 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                min="80"
                max="99"
                value={simulatedConfidenceThreshold}
                onChange={(e) => setSimulatedConfidenceThreshold(Number(e.target.value))}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                max="100"
                step="5"
                value={simulatedToleranceDelta}
                onChange={(e) => setSimulatedToleranceDelta(Number(e.target.value))}
      ...
      <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto w-full border-t border-slate-800/60">
        ...
        <div className="text-center mb-12">
          ...
          <h3 className="text-2xl sm:text-3xl font-extrabold text-white font-sans">
            5 Layers of SettleWise Engineering
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="surface-card surface-card-hover p-6 rounded-2xl border border-slate-800/80 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-sans">
              Splits diagnostic reasoning across Root Cause, Merchant Context, and Tax & Fee Matcher sub-agents rather than relying on a single prompt.
            </p>
          </div>
          ...
          <div className="surface-card surface-card-hover p-6 rounded-2xl border border-slate-800/80 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-sans">
              An independent Adversarial Auditor Agent actively attempts to disprove primary agent conclusions (testing for duplicate payout injection & timing drift).
            </p>
          </div>
          ...
          <div className="surface-card surface-card-hover p-6 rounded-2xl border border-slate-800/80 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-sans">
              Hard mathematical guardrails (confidence caps, margin deltas, ledger arithmetic checks) govern money movement with zero hallucination risk.
            </p>
          </div>
          ...
          <div className="surface-card surface-card-hover p-6 rounded-2xl border border-slate-800/80 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-sans">
              Simulate 50 to 10,000 transaction batches with ground truth to measure precision, recall, and honest exception stopping rates in real time.
            </p>
          </div>
          ...
          <div className="surface-card surface-card-hover p-6 rounded-2xl border border-slate-800/80 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-sans">
              Explicitly isolates ambiguous cases (like duplicate payout candidates) to protect the ledger against double reconciliation errors.
            </p>
          </div>
          ...
          <div className="surface-card surface-card-hover p-6 rounded-2xl border border-slate-800/80 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed font-sans">
              Automatically packages dispute claim files for intermediate bank fee deductions and un-webhooked drops to recover leaked capital.
            </p>
          </div>
        ...
        <div className="surface-card p-8 sm:p-12 rounded-3xl border border-indigo-500/30 relative overflow-hidden">
          <div className="relative z-10 space-y-4 max-w-2xl mx-auto">
            <h3 className="text-2xl sm:text-4xl font-extrabold text-white font-sans">
              Ready to Explore the Controller Terminal?
            </h3>
            <p className="text-xs sm:text-sm text-slate-400">
              Run real-time discrepancy investigations across multi-source bank ledgers with SettleWise.
            </p>
            <div className="pt-2">
              <button
                onClick={() => onLaunchApp('DASHBOARD')}
                className="px-8 py-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm shadow-lg transition-all group inline-flex items-center gap-2 cursor-pointer"
              >
      ...
      <footer className="border-t border-slate-800/80 bg-[#080b12] py-6 px-6 lg:px-12 mt-auto text-center text-xs font-mono text-slate-500">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            SettleWise — Razorpay AI Buildathon 2026 | Track 04 — AI Finance Controller
          </div>
          <div>
            Principle: <strong className="text-slate-300">AI Investigates.</strong> <strong className="text-emerald-400">Rules Authorize.</strong>
          </div>
        </div>
      </footer>
