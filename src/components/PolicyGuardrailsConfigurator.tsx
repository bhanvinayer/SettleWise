...
export const PolicyGuardrailsConfigurator: React.FC<PolicyGuardrailsConfiguratorProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 lg:p-6 overflow-y-auto theme-modal">
      <div className="bg-[#0b0f19] border border-slate-800 rounded-2xl w-full max-w-2xl flex flex-col shadow-2xl overflow-hidden theme-modal-panel">
        
        {/* Header */}
        <div className="px-6 py-4 border-b border-slate-800 bg-slate-900/60 flex items-center justify-between theme-modal-header">
        ...
        {/* Footer */}
        <div className="px-6 py-4 border-t border-slate-800 bg-[#080b12] flex items-center justify-between theme-modal-footer">
          <button
            onClick={handleReset}
